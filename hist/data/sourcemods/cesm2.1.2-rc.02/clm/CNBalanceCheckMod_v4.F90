...
contains
  ...
  subroutine Init(this, bounds)
    ...
    ! BGB: increase carbon error tolerance to avoid initial instability after introducing new parameter set
    ! this%cerror   = 1.e-7_r8
    ! this%cerror   = 1.e-6_r8  ! first try (v1)
    ! this%cerror   = 1.e-5_r8  ! second try (v2)
    ! this%cerror   = 1.e-4_r8  ! third try (v3)
    this%cerror   = 1.e-3_r8  ! fourth try (v4)
  end subroutine Init
